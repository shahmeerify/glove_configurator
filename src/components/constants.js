...
import rainbow from '../assets/textures/rainbow/rainbow.jpg'
...
export const meshOptions = {
  binding: {
    ...
    textures: {"Shiny Silver": silvershiny, "Shiny Gold": goldshiny , "Shiny Red": redshiny , "Shiny Blue": blueshiny, },
  ...
  export const personlizationConfig = {
    "Thumb Logo/Graphic" : true,
    "Thumb Graphic": false,
