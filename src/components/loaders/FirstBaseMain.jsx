...
import { FirstBase } from "../customizers/Firstbase";


export default function FirstBaseMain() {
  const [currentTab, setCurrentTab] = useState(tabs[0]);
  const [rotationValue, setRotationValue] = useState(31.1); 
